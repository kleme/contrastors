...
class ContrastiveDataArgs(DataArgs):
    ...
    from_hub: Optional[bool] = True
    weighted_sampling: Optional[bool] = False
    verbose: Optional[bool] = False
    seq_len: Optional[int] = None
    text_code: Optional[bool] = False
    filter_type: Optional[str] = None
    filter_k: Optional[int] = None
    mine_type: Optional[str] = None
    mine_abs_threshold: Optional[float] = None
    neg_abs_margain: Optional[float] = None 
    neg_perc_margain: Optional[float] = None
    neg_start_range: Optional[int] = 0
    neg_end_range: Optional[int] = int(1e6)
    add_eos_mask: Optional[bool] = False
    pre_apply_neg_mining: Optional[bool] = False
    temperature_start: Optional[float] = 0.5
    temperature_end: Optional[float] = 0.1
    temp_decay_type: Optional[str] = 'linear'
    filter_256: Optional[bool] = False
...
class ModelArgs(BaseModel):
    ...
    is_cross_encoder: Optional[bool] = False
    seq2seq: Optional[bool] = False
    is_joint_encoder: Optional[bool] = False
    ...
    skip_add_tok: Optional[bool] = False
